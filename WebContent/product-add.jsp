...
<div class="page-container">
	<form class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<select name="" class="select">
					...
					<option value="11">三年级</option>
					<option value="12">四年级</option>
					<option value="13">五年级</option>
				</select>
				</span>
			</div>
		</div>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">商品展示图片上传：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<div class="uploader-list-container"> 
					<div class="queueList">
						<div id="dndArea" class="placeholder">
							<div id="filePicker-2"></div>
							<p>默认第一张为商品展示图，其余为商品详情图，最多上传300张</p>
						</div>
					</div>
